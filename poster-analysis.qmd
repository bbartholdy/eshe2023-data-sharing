---
title: Open data in Paleoanthropology
execute: 
  warning: false
  freeze: auto
knitr: 
...
colleagues (2022) and made available under a CC0 license.
...
exp_theme <- theme(
  ...
  axis.text.y = element_text(family = "Arial", size = 28),
...
ggsave("figures/poster_benefits-negatives.png", height = 18, width = 34, units = "in")
```
